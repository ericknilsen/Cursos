package design.protorype.cloneable;
...
class Person implements Cloneable {
	...
	@Override
	public String toString() {
		return "Person{" + "names=" + Arrays.toString(names) + ", address="
				+ address + '}';
	}
	...
	public Object clone() throws CloneNotSupportedException {
		...
		// clone() creates a shallow copy!
				...
				address instanceof Cloneable ? (Address) address.clone()
						: address);
	}
}

class CloneableIsBad {
